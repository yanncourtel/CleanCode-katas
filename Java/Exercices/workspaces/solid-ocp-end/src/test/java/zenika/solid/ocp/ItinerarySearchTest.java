...
public class ItinerarySearchTest {
    ...
    @Test public void should_find_shortest_itinerary() {
        ...
        Optional<Itinerary> optionalShortest =  search.optimalItinerary(trip, Itinerary::duration);
    ...
    @Test public void should_find_cheapest_itinerary() {
        ...
        Optional<Itinerary> optionalCheapest =  search.optimalItinerary(trip, Itinerary::cost);
